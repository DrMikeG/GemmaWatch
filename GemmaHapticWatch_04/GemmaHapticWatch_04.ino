...
const uint32_t           // These may be the only lines you need to edit...
  onTime   =  1 * 1000L, // Vibration motor run time, in milliseconds
  interval = 15 * 60  * 1011L; // Time between reminders, in milliseconds
                         // It gets progressively geekier from here...

// In practice, I've found that in the period from about 8:30am to 5pm 
// this watch gains about 5 minutes.
// So we want to add an extra 5 minutes every 7.5hours (450 minutes)
// So thats a factor of 455/450 91/90
// So we fudge 1000ms to 1011 ms
